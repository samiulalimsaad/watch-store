    ...
    return (
        <div className="text-slate-900">
            ...
            <div className="space-y-4">
                ...
                <p>
                    There has few steps to use Context Api
                ...
                <p>
                    Context Provider allow to pass a value property as props
                    which is actual data.
                </p>
                <p>
                    Context must be exported. otherwise Context Consumer
                    wouldn't able to use it.
                </p>
            </div>
        </div>
    );
